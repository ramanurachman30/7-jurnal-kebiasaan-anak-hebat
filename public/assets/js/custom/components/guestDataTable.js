...
let eventSlug = $("meta[name='event-slug']").attr('content');
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            dom += `<div class="px-3 menu-item">
                                    <a href="/guest/${eventSlug}?to=${data.slug}" class="px-3 menu-link d-flex justify-content-between" data-kt-user-table-filter="edit_row" target="_blank"> 
