        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            dom += `<div class="px-3 menu-item">
                                        <a href="${firstSegment}/${data.id}/guest" class="px-3 menu-link" data-kt-user-table-filter="edit_row">
                                            Invitation
                                        </a>
                                    </div>`;
            dom += `<div class="px-3 menu-item">
                                    <a href="${firstSegment}/${data.id}/attandance" class="px-3 menu-link d-flex justify-content-between" data-kt-user-table-filter="edit_row">
                                        <span>Attandance</span>    <i class="fas fa-qrcode"></i> 
                                    </a>
                                </div>`;
            dom += `<div class="px-3 menu-item">
                                    <a href="${firstSegment}/${data.id}/listener" class="px-3 menu-link d-flex justify-content-between" data-kt-user-table-filter="edit_row">
                                        <span>Listener</span>    <i class="fas fa-binoculars"></i> 
                                    </a>
                                </div>`;
            if (isAllowToUpdate) {
              dom += `<div class="px-3 menu-item">
