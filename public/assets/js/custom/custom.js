$(function () {
                ...
                $.ajax({
                    ...
                    success: function (resp) {
                        Swal.fire({
                            ...
                            const redirectUrl = $(e.target).closest('.delete-row').data('redirect');
                            if (redirectUrl) {
    ...
    // DELETE ROW FROM TABLE REPEATER
    ...
    $(document).on('click', '.less', function(){
        ...
        $(this).closest('tr').find('.more').removeClass('d-none');
    });

    $(document).on('click', '.more', function(){
        $(this).addClass('d-none');
        $(this).closest('tr').find('.less').removeClass('d-none');
    });
});
