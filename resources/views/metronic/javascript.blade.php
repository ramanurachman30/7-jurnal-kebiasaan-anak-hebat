...
<script src="{{ asset('assets/js/custom/components/imagerepeater.js') }}"></script>
<script src="{{ asset('assets/js/custom/components/sluggable.js') }}"></script>
<script src="{{ asset('assets/js/custom/components/quil.js') }}"></script>
<script src="{{ asset('assets/js/custom/components/MultiThumbnailManager.js') }}"></script>
<script src="{{ asset('assets/js/custom/components/fileuploadRepeater.js') }}"></script>
