                    ...
                    <div data-repeater-item>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" class="mb-2 form-control mb-md-0" placeholder="Enter {{ $items['label'] }}" /> --}}
                            </div>
                            @endforeach
                            <div class="col-md-4">
                                <a href="javascript:;" data-repeater-delete class="mt-3 btn btn-sm btn-light-danger mt-md-8">
