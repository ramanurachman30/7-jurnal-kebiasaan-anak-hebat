...
<head>
    <title>{{ env('APP_NAME') }} | {{ __(ucwords(str_replace('_', ' ', request()->segment(2)))) }}</title>
    <base href="" />
    <meta charset="utf-8" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="token" content="{{ session('bearer_token') }}" value="{{ csrf_token() }}" />
...
<body
    ...
    id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
    ...
    <div class="app-page-loader page-loader-logo d-block">
        <div class="d-flex align-items-center justify-content-center flex-column h-100">
            <img alt="Logo" class="max-h-110px logo-spinner"
                src="{{ asset('assets/media/logos/logo-id.PNG') }}" width="80">
                &nbsp;
                <h1>Kementerian Energi dan Sumber Daya Mineral</h1>
