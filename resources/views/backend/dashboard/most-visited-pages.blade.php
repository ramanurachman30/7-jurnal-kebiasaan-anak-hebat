                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="my-1 d-flex align-items-center position-relative">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                ...
                                placeholder="{{ __('Search Full Page Url') }}" />
                        </div>
                            ...
                            <table class="table table-striped border table-rounded gy-7 gs-7" id="google-analityc">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200">
                                        <th class="text-nowrap">{{ __('Full Page Url') }}</th>
...
@section('customjs')
    <script src="{{ asset('assets/js/custom/pages/dashboard/dataTableMostVisitedPages.js') }}"></script>
@endsection
