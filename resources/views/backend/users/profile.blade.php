    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                <div class="flex-wrap d-flex">
                                    <div
                                        ...
                                        <div class="text-gray-400 fw-semibold fs-6">{{ __('Login Attempts') }}</div>
                                    </div>
                                </div>
                            </div>
                ...
                <ul class="border-transparent nav nav-stretch nav-line-tabs nav-line-tabs-2x fs-5 fw-bold">
                    ...
                    <li class="mt-2 nav-item">
                        <a class="py-5 nav-link text-active-primary ms-0 me-10"
                            href="{{ url('admin/'. Request::segment(2) . '/update_profile') }}">{{ __('Update Profile') }}</a>
                    </li>
                    <li class="mt-2 nav-item">
                        <a class="py-5 nav-link text-active-primary ms-0 me-10"
        ...
        <div class="mb-5 card mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    <label class="col-lg-1 fw-semibold text-muted text-end">{{ __('Email') }}</label>
                    <div class="col-lg-8 fv-row">
                        <span class="text-gray-800 fw-semibold fs-6">{{ $model['email'] }}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-1 fw-semibold text-muted text-end">{{ __('Phone Number') }}</label>
                    <div class="col-lg-8 d-flex align-items-center">
                        <span class="text-gray-800 fw-bold fs-6 me-2">{{ $model['phone_number'] }}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-1 fw-semibold text-muted text-end">{{ __('Address') }}</label>
                    <div class="col-lg-8">
                        <span class="text-gray-800 fw-bold fs-6 me-2">{{ $model['address'] }}</span>
                    </div>
                </div>
                <div class="row mb-7">
