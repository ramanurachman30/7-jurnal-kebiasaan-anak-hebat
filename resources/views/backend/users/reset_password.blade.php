        ...
        <div class="card-body pt-9 pb-0">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="" data-kt-initialized="1">90</div>
                                    </div>
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ url('admin/'. Request::segment(2) . '/profile') }}">{{ __('Profil') }}</a>
                </li>
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ url('admin/'. Request::segment(2) . '/update_profile') }}">{{ __('Update Profile') }}</a>
                </li>
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="#">{{ __('Update Password') }}</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-footer d-flex bd-highlight">
            <div class="flex-grow-1 bd-highlight">
                <!--begin::Button-->
                <button type="button" id="kt_btn_1" class="btn btn-primary btn-submit me-3" onclick="$('#resetPassword').submit()">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="{{ url('admin/'. Request::segment(2)) }}" type="button" class="btn btn-light">{{ __('Batal') }}</a>
            </div>
        </div>
    </div>
</div>
