                ...
                <div class="card card-flush h-md-100">
                    <div class="card-header pt-7">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Add user-->
                            @if (Auth::allowedUri(url('admin/'. Request::segment(2) . '/create')))
                                <a href="{{ url('admin/'. Request::segment(2) . '/create') }}" class="btn btn-primary">
                                    ...
                                    <!--end::Svg Icon-->{{ __('Add') }} {{ __($segmentName) }}
                                </a>
                            @endif
                            <!--end::Add user-->
                        </div>
                    ...
                    console.log(data);
                        ...
                        var action = `
                            ...
                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px" data-kt-menu="true">
                                ...
                                <div class="px-3 menu-item">
                                    <a data-remote="{{ url('api/admin/'.Request::segment(2)) }}/${data.id}/trash" class="px-3 menu-link" data-kt-user-table-filter="delete_row">
                                        {{ __('Delete') }}
                                    </a>
                                </div>
                                @endif
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    const url = `{{ url('api/admin/'.Request::segment(2)) }}/${selectedList}/trash`;
                    $.ajax({
                        url: url,
                        type: "POST",
                        headers: {
