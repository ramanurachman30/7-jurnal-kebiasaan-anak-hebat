...
@section('meta')
    ...
    <meta name="permission" restore="{{ Auth::allowedUri(Request::segment(2) . '.restore') ? true : false }}"
        delete="{{ Auth::allowedUri(Request::segment(2) . '.delete') ? true : false }}">
...
@section('toolbar')
    <a href="{{ url()->previous() }}" class="btn btn-light-success">
        <span
            class="svg-icon svg-icon-success svg-icon-2"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Navigation/Arrow-left.svg--><svg
